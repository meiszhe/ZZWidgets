 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `BRSModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface BRSAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation BRSAuthor
     @end
 
     @interface BRSBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) BRSAuthor *author;
     @end
     @implementation BRSBook
     @end
    
     int main() {
         // create model from json
         BRSBook *book = [BRSBook brs_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book brs_modelToJSONString];
 ...
 @code
     @interface BRSShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation BRSShadow
    - (void)encodeWithCoder:(NSCoder *)aCoder { [self brs_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self brs_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self brs_modelCopy]; }
     - (NSUInteger)hash { return [self brs_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self brs_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (BRSModel)

+ (NSDictionary *)brs_dictionaryWithJSON:(id)json;
 ...
 */
+ (nullable instancetype)brs_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)brs_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)brs_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)brs_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)brs_modelToJSONObject;
 ...
 */
- (nullable NSData *)brs_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)brs_modelToJSONString;
 ...
 */
- (void)brs_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)brs_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)brs_modelIsEqual:(id)model;
 ...
 */
+ (nullable NSArray *)brs_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (BRSModel)
 ...
 */
+ (nullable NSDictionary *)brs_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<BRSModel>' to your class header.
 */
@protocol BRSModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class BRSShadow, BRSBorder, BRSAttachment;
 
        @interface BRSAttributes
        @property NSString *name;
        ...
        @implementation BRSAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [BRSShadow class],
                     @"borders" : BRSBorder.class,
...
/**
 ...
 Example:
 @code
        @class BRSCircle, BRSRectangle, BRSLine;
 
        @implementation BRSShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [BRSCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [BRSRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [BRSLine class];
            } else {
                return [self class];
            }
        }
