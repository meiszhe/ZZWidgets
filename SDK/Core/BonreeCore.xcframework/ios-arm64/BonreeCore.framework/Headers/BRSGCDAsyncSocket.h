...
@class BRSGCDAsyncReadPacket;
@class BRSGCDAsyncWritePacket;
@class BRSGCDAsyncSocketPreBuffer;
@protocol BRSGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const BRSGCDAsyncSocketException;
extern NSString *const BRSGCDAsyncSocketErrorDomain;

extern NSString *const BRSGCDAsyncSocketQueueName;
extern NSString *const BRSGCDAsyncSocketThreadName;

extern NSString *const BRSGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const BRSGCDAsyncSocketUseCFStreamForTLS;
#endif
#define BRSGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define BRSGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define BRSGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const BRSGCDAsyncSocketSSLPeerID;
extern NSString *const BRSGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const BRSGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const BRSGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const BRSGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const BRSGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const BRSGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define BRSGCDAsyncSocketLoggingContext 65535


typedef NS_ENUM(NSInteger, BRSGCDAsyncSocketError) {
	BRSGCDAsyncSocketNoError = 0,           // Never used
	BRSGCDAsyncSocketBadConfigError,        // Invalid configuration
	BRSGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	BRSGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	BRSGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	BRSGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	BRSGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	BRSGCDAsyncSocketClosedError,           // The remote peer closed the connection
	BRSGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface BRSGCDAsyncSocket : NSObject

/**
 * BRSGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, BRSGCDAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<BRSGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<BRSGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

/**
 * Create BRSGCDAsyncSocket from already connect BSD socket file descriptor
**/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<BRSGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq error:(NSError**)error;

+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<BRSGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<BRSGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<BRSGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<BRSGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<BRSGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<BRSGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * For accepting incoming connections, this means BRSGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means BRSGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, BRSGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, BRSGCDAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of BRSGCDAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a BRSGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a BRSGCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that BRSGCDAsyncSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - BRSGCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So BRSGCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - BRSGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default BRSGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct BRSGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, BRSGCDAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by BRSGCDAsyncSocket,
 ...
 *
 * - BRSGCDAsyncSocketSSLProtocolVersionMin
 * - BRSGCDAsyncSocketSSLProtocolVersionMax
 ...
 * 
 * - BRSGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - BRSGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - BRSGCDAsyncSocketSSLCipherSuites
 ...
 *
 * - BRSGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see BRSGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use BRSGCDAsyncSocketSSLProtocolVersionMin & BRSGCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * BRSGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(BRSGCDAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(BRSGCDAsyncSocket *)sock didAcceptNewSocket:(BRSGCDAsyncSocket *)newSocket
 * {
 ...
 * Example usage:
 * 
 * - (void)socket:(BRSGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port
 * {
...
@protocol BRSGCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(BRSGCDAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(BRSGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;

/**
 * Called when a socket has completed reading the requested data into memory.
 * Not called if there is an error.
**/
- (void)socket:(BRSGCDAsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag;
...
**/
- (void)socket:(BRSGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(BRSGCDAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(BRSGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(BRSGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(BRSGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(BRSGCDAsyncSocket *)sock;
 ...
 * 
 * Note: If the BRSGCDAsyncSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(BRSGCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socket:(BRSGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
